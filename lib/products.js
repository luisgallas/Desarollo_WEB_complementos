...
export const products = [
  ...
  },
  {
    ...
    description: "Un compañero en tu muñeca para seguir tu actividad y ver tus notificaciones.",
  ...
  },
  {
    ...
    description: "Tu espacio de estudio y trabajo, listo para acompañarte a donde vayas.",
    whatsappMessage: "Hola, quiero consultar por la Notebook N1.",
    specs: ["Formato portatil", "Almacenamiento SSD", "Conectividad Wi-Fi", "Procesador Intel Core i5"],
  },
  {
