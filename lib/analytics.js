...
// Importa la configuracion de demo y Google Analytics 4.
...
export function initGoogleAnalytics(measurementId = GA_MEASUREMENT_ID) {
  ...
  // Activa la medicion base de GA4, incluyendo page_view inicial.
...
function gaParams(entry) {
  ...
  // GA4 usa "value" para importes; se conserva "price" por el requisito academico.
